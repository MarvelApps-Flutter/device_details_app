...
import 'dart:io';
import 'package:device_details_app/constants/app_constants.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            Platform.isAndroid
                ? AppConstants.androidDevice
                : Platform.isIOS
                    ? AppConstants.iosDevice
                    : '',
          ),
        ),
                  ...
                  ? Padding(
                      ...
                      child: ListTile(
                        ...
                        title: _deviceData != null
                            ? Text(androidDeviceDataList[index].title!,
                        ...
                        subtitle: _deviceData != null
                            ? Text(androidDeviceDataList[index].description!,
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText1!
                                    .copyWith(
                        ...
                        child: ListTile(
                          dense: true,
                            ...
                            title: _iosDeviceData != null
                                ? Text(iosDeviceDataList[index].title!,
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText1!
                                        .copyWith(
                            ...
                            subtitle: _iosDeviceData != null
                                ? Text(iosDeviceDataList[index].description!,
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText1!
                                        .copyWith(
  ...
  getAndroidData() {
    if (Platform.isAndroid && _deviceData != null) {
      for (int i = 0; i < androidDeviceDataList.length; i++) {
        ...
        androidDeviceDataList[2].description = _deviceData!.version.release;
        androidDeviceDataList[3].description =
            _deviceData!.version.previewSdkInt.toString();
        androidDeviceDataList[4].description = _deviceData!.version.incremental;
        androidDeviceDataList[5].description = _deviceData!.version.codename;
        androidDeviceDataList[6].description = _deviceData!.version.baseOS;
        androidDeviceDataList[7].description = _deviceData!.board;
        androidDeviceDataList[8].description = _deviceData!.bootloader;
        ...
        androidDeviceDataList[12].description = _deviceData!.fingerprint;
        ...
        androidDeviceDataList[16].description = _deviceData!.manufacturer;
        ...
        androidDeviceDataList[26].description =
            _deviceData!.systemFeatures.take(5).join(',').replaceAll(',', '\n');
      }
    }
  }
  ...
  getIOSData() {
    if (Platform.isIOS && _iosDeviceData != null) {
      for (int i = 0; i < iosDeviceDataList.length; i++) {
        ...
        iosDeviceDataList[2].description = _iosDeviceData!.systemVersion;
        iosDeviceDataList[3].description = _iosDeviceData!.model;
        iosDeviceDataList[4].description = _iosDeviceData!.localizedModel;
        iosDeviceDataList[5].description = _iosDeviceData!.identifierForVendor;
        iosDeviceDataList[6].description =
            _iosDeviceData!.isPhysicalDevice == true ? "true" : "false";
        iosDeviceDataList[7].description = _iosDeviceData!.utsname.sysname;
        iosDeviceDataList[8].description = _iosDeviceData!.utsname.nodename;
        iosDeviceDataList[9].description = _iosDeviceData!.utsname.release;
        iosDeviceDataList[10].description = _iosDeviceData!.utsname.version;
        iosDeviceDataList[11].description = _iosDeviceData!.utsname.version;
      }
    }
  }
}
